...
This repository contains the materials for the Multilevel Measurement Models Workshop 2025, held 30 June - 4 July, 2025 at the Universität Mannheim. This workshop was held in the Research Training Group "Statistical Modeling in Psychology", funded by the [https://www.dfg.de/en](German Research Foundation (DFG)). It is organized by the DFG funded Research Training Group on [https://www.uni-mannheim.de/smip/](“Statistical Modeling in Psychology” (SMiP)) in collaboration with the [https://www.iops.nl/](Interuniversity Graduate School of Psychometrics and Sociometrics (IOPS)). Details about the event can be found at [https://www.uni-mannheim.de/smip-summerschool/](https://www.uni-mannheim.de/smip-summerschool/). 
